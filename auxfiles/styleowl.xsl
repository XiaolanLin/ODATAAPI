...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="display-steps">
		...
		<li>
		  <xsl:choose>
		    <xsl:when test="$step/oor:specification">
			...
			<font color="purple">
		      ...
		      <xsl:if test="$step/oor:hasAlternativeFlow|$step/oor:exception|$step/oor:includes">
			<ol>
			  <xsl:for-each select="$step/oor:hasAlternativeFlow">
			    <li>
			      Alternative Flow:
			      <font color="purple">
				<xsl:element name="a">
			  ...
			  <xsl:for-each select="$step/oor:exception">
			    <li>
			      Exception:
			      <font color="purple">
				<xsl:element name="a">
		    ...
		    <xsl:when test="$step/oor:includes">
		      <xsl:for-each select="$step/oor:includes[1]">
			Includes:
			<font color="purple">
			  <xsl:element name="a">
			    <xsl:attribute name="href">
